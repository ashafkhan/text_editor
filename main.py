...
# Use "Calibri" if available, otherwise use the first available font
if "Calibri" in fonts:
...
over_strike_button = Button(root, image=strike_icon, relief=FLAT, fg='black', font=('Arial', 12, 'overstrike'),
                            bg='white',
                            command=over_strike)
...
cut_button = Button(root, image=cut_icon, relief=FLAT, fg='black', font=('Arial', 12), bg='white', command=cut,
                    height=0,
                    )
hover(cut_button, on_entrance='#0084BA', on_exit='white', entrance_fg='white', exit_fg='black')
cut_button.place(x=520, y=(-1))

copy_button = Button(root, image=copy_icon, relief=FLAT, fg='black', font=('Arial', 12), bg='white', command=copy,
                     height=0,
                     )
hover(copy_button, on_entrance='#0084BA', on_exit='white', entrance_fg='white', exit_fg='black')
...
for button, description in button_descriptions.items():
    button.bind("<Enter>",
                lambda event, desc=description, btn=button: show_tooltip(desc, btn.winfo_rootx(), btn.winfo_rooty()))
